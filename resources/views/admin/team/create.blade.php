...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form id="teamMemberForm" method="POST" action="{{ route('admin.team.store') }}" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="position" class="form-control" value="{{ old('position') }}" placeholder="e.g. Founder, Director, Coordinator">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="bio" class="form-control nicEdit" rows="10">{{ old('bio') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <small class="text-muted">
                                                ...
                                                @lang('Leave blank if not available. URLs must include http:// or https://')
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="image-upload-preview text-center mb-3">
                                            <img src="{{ asset('assets/images/default-team.jpg') }}" 
                                                 alt="Preview" 
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="imageUpload">@lang('Choose file')</label>
                                        </div>
                                        
                                        <small class="form-text text-muted mt-2">
                                            <i class="las la-info-circle"></i>
                                            @lang('Supported files: jpg, jpeg, png, gif. Max size: 2MB')
                                        </small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="border-top pt-4 d-flex justify-content-end gap-3">
                                ...
                                <button type="submit" class="btn btn--primary">
                                    <i class="las la-save"></i> @lang('Save Member')
                                </button>
                            </div>
                        </div>
                    </div>
