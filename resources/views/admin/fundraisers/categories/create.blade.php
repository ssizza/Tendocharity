{{-- resources/views/admin/fundraisers/categories/create.blade.php --}}
...
<div class="row">
    <div class="col-lg-12">
        <div class="card b-radius--10">
            <div class="card-body">
                <form action="{{ route('admin.fundraisers.categories.store') }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control" required>
                                            ...
                                            <option value="inactive" @selected(old('status') == 'inactive')>@lang('Inactive')</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
