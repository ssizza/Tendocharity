    ...
    <div class="col-lg-12">
        <div class="card b-radius--10">
            <div class="card-header">
                <h5 class="card-title">@lang('Create New Cause')</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.fundraisers.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="urgency_level" class="form-select" required>
                                                    <option value="normal" @selected(old('urgency_level') == 'normal')>@lang('Normal')</option>
                                                    <option value="urgent" @selected(old('urgency_level') == 'urgent')>@lang('Urgent')</option>
                                                    <option value="critical" @selected(old('urgency_level') == 'critical')>@lang('Critical')</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-select" required>
                                                    <option value="draft" @selected(old('status') == 'draft')>@lang('Draft')</option>
                                                    <option value="pending" @selected(old('status') == 'pending')>@lang('Pending')</option>
                                                    <option value="active" @selected(old('status') == 'active')>@lang('Active')</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description" class="form-control" rows="3" maxlength="500" required>{{ old('short_description') }}</textarea>
                                        <div class="text-end">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" rows="10" id="description-editor">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="target_amount" class="form-control" step="0.01" min="0" value="{{ old('target_amount') }}" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="currency" class="form-control" value="{{ old('currency', 'USD') }}" maxlength="3" required>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="project_leader" class="form-control" value="{{ old('project_leader') }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="organization_type" class="form-control" value="{{ old('organization_type') }}">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="problem_statement" class="form-control" rows="5">{{ old('problem_statement') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">@lang('Solution Statement')</label>
                                                <textarea name="solution_statement" class="form-control" rows="5">{{ old('solution_statement') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="beneficiaries" class="form-control" rows="3">{{ old('beneficiaries') }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total_beneficiaries_target" class="form-control" value="{{ old('total_beneficiaries_target') }}" min="0">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="form-label">@lang('Project Scope')</label>
                                        <textarea name="project_scope" class="form-control" rows="5">{{ old('project_scope') }}</textarea>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="form-label">@lang('Risks & Challenges')</label>
                                        <textarea name="risks_challenges" class="form-control" rows="5">{{ old('risks_challenges') }}</textarea>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="form-label">@lang('Sustainability Plan')</label>
                                        <textarea name="sustainability_plan" class="form-control" rows="5">{{ old('sustainability_plan') }}</textarea>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="timeline[0][phase]" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="form-label">@lang('Duration')</label>
                                                            <input type="text" name="timeline[0][duration]" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="form-label">@lang('Description')</label>
                                                            <textarea name="timeline[0][description]" class="form-control" rows="2"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg--primary">
                                    <h6 class="card-title text-white mb-0">@lang('Featured Image') <span class="text-danger">*</span></h6>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="image-upload">
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview" style="background-image: url({{ asset('assets/images/default.png') }})"></div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="location_region" class="form-control" value="{{ old('location_region') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <button type="submit" class="btn btn--primary btn-lg w-100">
                                <i class="las la-plus-circle"></i> @lang('Create Cause')
                            </button>
                        </div>
                    </div>
                </form>
